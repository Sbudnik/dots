...
(defun jwm/set-font-faces ()
   ...
   (set-face-attribute 'default nil :font "Calibri Light" :height jwm/default-font-size)
   ;; Set the fixed pitch face
   (set-face-attribute 'fixed-pitch nil :font "Inconsolata" :height 145)
   ;; Set the variable pitch face
   (set-face-attribute 'variable-pitch nil :font "Calibri Light" :height 150 :weight 'regular))
