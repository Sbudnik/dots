...
(setq org-agenda-files '("C:/Users/jwmosty/AppData/Roaming/org/"))
...
* Python
#+begin_src emacs-lisp
(setq org-babel-python-command "c:/msys64/usr/bin/python3.8.exe")
(setq python-shell-interpreter "c:/msys64/usr/bin/python3.8.exe")
#+end_src
* Custom variable
#+begin_src emacs-lisp
